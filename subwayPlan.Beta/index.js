...
//     let showLine = readlineSync.question('lineInput:  ');
//     let subMap = showLine.split(' ');
//     if (subMap.length == 2) {
//         if (subMap[0] === '-map') {
...
// }
// function searchSub() {
//     // let showLine = readlineSync.question('lineInput:  ', 'utf8');
//     // let subMap = showLine.split(' ');
//     // if (subMap.length === 6) {
...
//     //         else {
//     //             fs.writeFileSync('./station.txt', timi);
//     //             console.log('已写入文件');
//     //         }
//     //     } else {
//     //         console.log('输入错误!');
...
//     rl.question('', answer => {
//         console.log(answer.length);//common
//         let subMap = answer.split(' ');
//         console.log(subMap);//common
//         if (subMap.length === 6) {
//             if (subMap[0] === '-a' && subMap[2] === '-map' && subMap[3] === 'subway.txt') {
//                 console.log(subMap[1]);
//                 let timi = findSub(subMap[1]);
...
//                 if (subMap[4] !== '-o') console.log('文件读入命令不存在');
//                 else {
//                     fs.writeFileSync(subMap[5], timi);//会覆盖之前的文件内容
//                     console.log('已写入文件');
//                 }
//             } else {
//                 console.log('输入错误!');
